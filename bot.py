...
TOKEN = "7972245570:AAHvYgyXArhi0dQ__Zoi6NCkVbYQeX189-c"
...
async def hazil(update: Update, context: ContextTypes.DEFAULT_TYPE):
    hazillar = [
        "Telefon zaryadi 1% — hamma narsani saqlash rejimi 😂",
        "Institut: 'Nima o'qiysiz?' Mirodil: 'Pul ishlashni' 😅",
        "Do'stim: 'Sen hech o'zgarmaysan' Men: 'Rahmat' Do'stim: 'Maqtov emas edi' 😂",
        "Uyqu: 'Kel' Dars: 'Kel' Ikkalasi: 'Kel' Men: 😵",
    ]
...
async def eslatma(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    reminders.append({"matn": matn, "vaqt": datetime.now().strftime("%d.%m %H:%M")})
